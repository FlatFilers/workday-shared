export const blueprint = [
    {
        ...
        fields: [
            ...
            },
            {
                ...
                label: 'Country',
                type: 'enum',
                description: 'Populate this column with \"United State of America\" for each worker. Do not abbreviate.',
                config: { options: [{ value: 'USA', label: 'United States of America', }, { value: 'XXX', label: 'Other', },], },
            ...
            },
            {
                ...
                type: 'string',
                description: 'This field should auto populate as First Name, Middle Name, and Last Name are entered into those columns.'
            ...
            },
            {
                ...
                type: 'string',
                description: 'If the worker goes by a first name other than their legal one, list it here.',
            },
            {
            ...
            },
            {
                ...
                label: 'Email (Work)',
                type: 'string',
                description: 'Please populate this column with each worker\'s work email address. Make sure to enter the entire email in a standard email format. (ex. joe.brown@company.com).',
            ...
            },
            {
                ...
                label: 'Worker Type',
                type: 'enum',
                description: 'Choose a value from the dropdown menu. Select \"Employee\" if the worker is paid by your company. Select \"Contingent Worker\" if the worker is a contracted worker that is not paid by your company.',
                config: { options: [{ value: 'EE', label: 'Employee', }, { value: 'CW', label: 'Contingent Worker', },], },
                constraints: [{ type: 'required' }],
            },
            {
                ...
                type: 'enum',
                description: 'Choose a value from the dropdown menu. If the SubType has \"(with End Date)\" in the name, then an end date should be provided in the \"Termination/Contract End Date\" column.',
                config: {
                    options: [
            ...
            },
            {
                ...
                type: 'date',
                description: 'If the worker has been indicated as Terminated OR they are a contingent worker, a date for end of employemt should be provided here. If none is provided, an end date of 12-31-2099 will be defaulted in and can be manually fixed after loading.'
            },
            {
            ...
            },
            {
                ...
                label: 'Job Profile',
                type: 'reference',
                description: 'Choose a job profile from the dropdown menu. The menu consists of Job Profiles you entered into the tenant during an earlier journey.',
                constraints: [{ type: 'required' }],
                config: {
                    ref: 'jobs',
                    key: 'code',
            ...
            },
            {
                ...
                label: 'Time Type',
                type: 'enum',
                description: 'Enter whether the worker is a full time worker or part time worker',
                config: { options: [{ value: 'Full_time', label: 'Full time', }, { value: 'Part_time', label: 'Part time', },], },
                constraints: [{ type: 'required' }],
            },
            {
                ...
                label: 'Company Name',
                type: 'reference',
                description: 'Choose a Company from the dropdown menu. The menu consists of Company/Companies you entered into the tenant during an earlier journey.',
                constraints: [{ type: 'required' }],
                config: {
                    ref: 'companies',
                    key: 'name',
            ...
            },
            {
                ...
                label: 'Location ID',
                type: 'reference',
                description: 'Choose a Location from the dropdown menu. The menu consists of Locations you entered into the tenant during an earlier journey.',
                constraints: [{ type: 'required' }],
                config: {
                    ref: 'locations',
                    key: 'id',
            ...
            },
            {
                ...
                type: 'reference',
                description: 'Choose a Cost Center from the dropdown menu. The menu consists of Cost Centers you entered into the tenant during an earlier journey.',
                constraints: [{ type: 'required' }],
                config: {
                    ref: 'cost_centers',
                    key: 'name',
            ...
            },
            {
                ...
                config: { options: [{ value: 'Hourly', label: 'Hourly', }, { value: 'Salary', label: 'Salary', },], },
                constraints: [{ type: 'required' }],
            ...
            },
            {
                ...
                type: 'enum',
                description: 'Choose a Comp Grade from the dropdown menu. The menu consists of Comp Grades you entered into the tenant during an earlier journey.',
                config: { options: [{ value: 'Salary', label: 'Salary', }, { value: 'Hourly', label: 'Hourly', },], },
                constraints: [{ type: 'required' }],
            ...
            },
            {
                ...
                type: 'string',
                readonly: true,
                description: 'Enter the worker\'s compensation rate. Enter the hourly rate for hourly workers and the annual salary for salaried workers.',
                constraints: [{ type: 'required' }],
            },
            {
                key: 'User_Name',
                ...
                type: 'string',
                description: 'Enter the username that the worker will use to log into Workday.',
                constraints: [{ type: 'required' }],
            },
            {
                key: 'Password',
                ...
                type: 'string',
                description: 'Enter the password that the worker will use to log into Workday.',
                constraints: [{ type: 'required' }],
            },
            {
            ...
            },
            {
                ...
                type: 'enum',
                description: 'If the worker\'s home address is being provided in the next several columns, enter \"United States of America\" in this column. Leave it blank if an address is not being provided at this time.',
                config: { options: [{ value: 'USA', label: 'United States of America', }, { value: 'XXX', label: 'Other', },], },
            },
            {
                // I think this is how the key is built based on the generator table
                ...
                type: 'enum',
                description: 'Enter the worker\'s home address state. Make sure that the value input matched what is available in the dropdown menu of the cell.',
                config: {
                    options: [
            ...
            },
            {
                ...
                config: { options: [{ value: 'USA_Married', label: 'Married', }, { value: 'USA_Single', label: 'Single', }, { value: 'USA_Divorced', label: 'Divorced', }, { value: 'USA_Partnered', label: 'Partnered', }, { value: 'USA_Separated', label: 'Separated', }, { value: 'USA_Widowed', label: 'Widowed', },], },
            },
            {
                key: 'Gender_Code',
                label: 'Gender',
                ...
                config: { options: [{ value: 'Male', label: 'Male', }, { value: 'Female', label: 'Female', }, { value: 'Not_declared', label: 'Not declared', },], },
            },
            {
                // no key was listed for this in the generator table
                key: 'Date_Of_Birth',
                ...
                type: 'date',
                description: 'Enter the worker\'s date of birth formatted as \"yyyy-mm-dd\".',
                constraints: [{ type: 'required' }],
            },
            {
                key: 'National_ID',
                ...
                type: 'string',
                description: 'Enter the worker\'s social security number formatted as \"xxx-xx-xxxx\".',
                constraints: [{ type: 'required' }],
      ...
      },
      {
        ...
        primary: false,
      },
            {
                ...
                mode: 'background',
                label: 'Submit',
                description: 'Sends a webhook with a payload of IDs for API calls',
                primary: true
            }
        ]
    },
