...
export declare namespace Event {
    type Raw = Event.AgentCreated | Event.AgentUpdated | Event.AgentDeleted | Event.SpaceCreated | Event.SpaceUpdated | Event.SpaceDeleted | Event.DocumentCreated | Event.DocumentUpdated | Event.DocumentDeleted | Event.WorkbookCreated | Event.WorkbookUpdated | Event.WorkbookDeleted | Event.SheetCreated | Event.SheetUpdated | Event.SheetDeleted | Event.SnapshotCreated | Event.RecordsCreated | Event.RecordsUpdated | Event.RecordsDeleted | Event.FileCreated | Event.FileUpdated | Event.FileDeleted | Event.JobCreated | Event.JobUpdated | Event.JobDeleted | Event.JobFailed | Event.JobCompleted | Event.JobReady | Event.JobScheduled | Event.JobOutcomeAcknowledged | Event.CommitCreated | Event.CommitUpdated | Event.CommitCompleted | Event.LayerCreated;
