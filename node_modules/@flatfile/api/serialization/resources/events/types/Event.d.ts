...
export declare namespace Event {
    type Raw = Event.SpaceAdded | Event.SpaceRemoved | Event.WorkbookAdded | Event.WorkbookUpdated | Event.WorkbookRemoved | Event.UserAdded | Event.UserRemoved | Event.UserOnline | Event.UserOffline | Event.UploadStarted | Event.UploadFailed | Event.UploadCompleted | Event.JobStarted | Event.JobWaiting | Event.JobUpdated | Event.JobFailed | Event.JobCompleted | Event.JobDeleted | Event.RecordsCreated | Event.RecordsUpdated | Event.RecordsDeleted | Event.SheetValidated | Event.ActionTriggered | Event.FileDeleted | Event.ClientInitialized;
