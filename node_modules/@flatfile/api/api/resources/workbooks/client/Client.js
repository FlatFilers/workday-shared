...
class Workbooks {
     ...
     * @throws {@link Flatfile.NotFoundError}
     */
    clone(workbookId, requestOptions) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield ((_a = this._options.fetcher) !== null && _a !== void 0 ? _a : core.fetcher)({
                url: (0, url_join_1.default)((_b = (yield core.Supplier.get(this._options.environment))) !== null && _b !== void 0 ? _b : environments.FlatfileEnvironment.Production, `/workbooks/${yield serializers.WorkbookId.jsonOrThrow(workbookId)}/clone`),
                method: "POST",
                headers: {
                    Authorization: yield this._getAuthorizationHeader(),
                    "X-Disable-Hooks": "true",
     ...
     * @throws {@link Flatfile.NotFoundError}
     */
    getSheetsDeprecated(workbookId, requestOptions) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield ((_a = this._options.fetcher) !== null && _a !== void 0 ? _a : core.fetcher)({
                url: (0, url_join_1.default)((_b = (yield core.Supplier.get(this._options.environment))) !== null && _b !== void 0 ? _b : environments.FlatfileEnvironment.Production, `/workbooks/${yield serializers.WorkbookId.jsonOrThrow(workbookId)}/sheets`),
                method: "GET",
                headers: {
                    Authorization: yield this._getAuthorizationHeader(),
                    "X-Disable-Hooks": "true",
     ...
     * @throws {@link Flatfile.NotFoundError}
     */
    getRecordsDeprecated(workbookId, sheetId, request = {}, requestOptions) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const { versionId, untilVersionId, sinceVersionId, sortField, sortDirection, filter, filterField, searchValue, searchField, pageSize, pageNumber, includeCounts, includeLinks, includeMessages, } = request;
            const _queryParams = new url_search_params_1.default();
            if (versionId != null) {
            ...
            const _response = yield ((_a = this._options.fetcher) !== null && _a !== void 0 ? _a : core.fetcher)({
                url: (0, url_join_1.default)((_b = (yield core.Supplier.get(this._options.environment))) !== null && _b !== void 0 ? _b : environments.FlatfileEnvironment.Production, `/workbooks/${yield serializers.WorkbookId.jsonOrThrow(workbookId)}/sheets/${yield serializers.SheetId.jsonOrThrow(sheetId)}/records`),
                method: "GET",
                headers: {
                    Authorization: yield this._getAuthorizationHeader(),
                    "X-Disable-Hooks": "true",
     ...
     * @throws {@link Flatfile.NotFoundError}
     */
    updateRecordsDeprecated(workbookId, sheetId, request, requestOptions) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield ((_a = this._options.fetcher) !== null && _a !== void 0 ? _a : core.fetcher)({
                url: (0, url_join_1.default)((_b = (yield core.Supplier.get(this._options.environment))) !== null && _b !== void 0 ? _b : environments.FlatfileEnvironment.Production, `/workbooks/${yield serializers.WorkbookId.jsonOrThrow(workbookId)}/sheets/${yield serializers.SheetId.jsonOrThrow(sheetId)}/records`),
     ...
     * @throws {@link Flatfile.NotFoundError}
     */
    addRecordsDeprecated(workbookId, sheetId, request, requestOptions) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield ((_a = this._options.fetcher) !== null && _a !== void 0 ? _a : core.fetcher)({
                url: (0, url_join_1.default)((_b = (yield core.Supplier.get(this._options.environment))) !== null && _b !== void 0 ? _b : environments.FlatfileEnvironment.Production, `/workbooks/${yield serializers.WorkbookId.jsonOrThrow(workbookId)}/sheets/${yield serializers.SheetId.jsonOrThrow(sheetId)}/records`),
     ...
     * @throws {@link Flatfile.NotFoundError}
     */
    deleteRecordsDeprecated(workbookId, sheetId, request = {}, requestOptions) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const { ids } = request;
            const _queryParams = new url_search_params_1.default();
     ...
     * @throws {@link Flatfile.NotFoundError}
     */
    validateSheetDeprecated(workbookId, sheetId, requestOptions) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield ((_a = this._options.fetcher) !== null && _a !== void 0 ? _a : core.fetcher)({
                url: (0, url_join_1.default)((_b = (yield core.Supplier.get(this._options.environment))) !== null && _b !== void 0 ? _b : environments.FlatfileEnvironment.Production, `/workbooks/${yield serializers.WorkbookId.jsonOrThrow(workbookId)}/sheets/${yield serializers.SheetId.jsonOrThrow(sheetId)}/validate`),
                method: "POST",
                headers: {
                    Authorization: yield this._getAuthorizationHeader(),
                    "X-Disable-Hooks": "true",
     ...
     * @throws {@link Flatfile.NotFoundError}
     */
    createVersionDeprecated(workbookId, sheetId, requestOptions) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield ((_a = this._options.fetcher) !== null && _a !== void 0 ? _a : core.fetcher)({
                url: (0, url_join_1.default)((_b = (yield core.Supplier.get(this._options.environment))) !== null && _b !== void 0 ? _b : environments.FlatfileEnvironment.Production, `/workbooks/${yield serializers.WorkbookId.jsonOrThrow(workbookId)}/sheets/${yield serializers.SheetId.jsonOrThrow(sheetId)}/versions`),
                method: "POST",
                headers: {
                    Authorization: yield this._getAuthorizationHeader(),
                    "X-Disable-Hooks": "true",
